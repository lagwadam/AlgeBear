namespace UtilityLibraries
{
    ...
    public interface IExpression
    {
        ...
        T Accept<T>(IExpressionTreeVisitor<T> visitor, IExpression expression);
    ...
    public class Constant : IPrimative
    {
        ...
        public T Accept<T>(IExpressionTreeVisitor<T> visitor, IExpression expression)
        {
    ...
    public class Container : IContainer
    {
        ...
        public virtual T Accept<T>(IExpressionTreeVisitor<T> visitor, IExpression source)
        {
    ...
    public class Sum : BinaryOperation
    {
        ...
        public override T Accept<T>(IExpressionTreeVisitor<T> visitor, IExpression source) { return visitor.Visit(this, source); }
    }
